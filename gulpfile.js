...
getPaths = () => {
    return {
        ...
        js: {
            ...
            bootstrap: {
                all: [
                    "wwwroot/js/bootstrap/util.js",
                    "wwwroot/js/bootstrap/alert.js",
                    "wwwroot/js/bootstrap/button.js",
                    "wwwroot/js/bootstrap/carousel.js",
                    "wwwroot/js/bootstrap/collapse.js",
                    "wwwroot/js/bootstrap/dropdown.js",
                    "wwwroot/js/bootstrap/modal.js",
                    "wwwroot/js/bootstrap/tooltip.js",
                    "wwwroot/js/bootstrap/popover.js",
                    "wwwroot/js/bootstrap/scrollspy.js",
                    "wwwroot/js/bootstrap/toast.js",
                    "wwwroot/js/bootstrap/tab.js"
                ],
                index: "wwwroot/js/bootstrap/index.js"
            },
            mrare: {
                all: "wwwroot/js/mrare/**/*.js",
                index: "wwwroot/js/mrare/index.js",
            }
        },
        scss: {
            folder: 'scss',
            all: 'scss/**/*',
            root: 'scss/*.scss',
            themeScss: ['wwwroot/scss/theme.scss', '!scss/user.scss', '!scss/user-variables.scss'],
        },
        assets: {
            all: 'pages/assets/**/*',
            folder: 'pages/assets',
        ...
        dist: {
            packageFolder: '',
            folder: 'wwwroot/dist',
            pages: 'wwwroot/dist/pages',
            all: 'wwwroot/dist/**/*',
            assets: 'wwwroot/dist/assets',
            img: 'wwwroot/dist/assets/img',
            css: 'wwwroot/dist/assets/css',
            scssSources: 'wwwroot/dist/scss',
            js: 'wwwroot/dist/assets/js',
            jsSources: 'wwwroot/dist/js',
            fonts: 'wwwroot/dist/assets/fonts',
            video: 'wwwroot/dist/assets/video',
            documentation: 'wwwroot/dist/documentation',
